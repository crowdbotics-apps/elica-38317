"""
Django settings for elica_38317 project.
...
WSGI_APPLICATION = 'elica_38317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "elica_38317 API",
    "DESCRIPTION": "API documentation for elica_38317 App",
    "VERSION": "v1",
}
